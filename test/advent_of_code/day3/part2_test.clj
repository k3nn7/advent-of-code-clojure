(ns advent-of-code.day3.part2-test
    (:require [clojure.test :refer :all]
              [advent-of-code.day3.part2 :refer :all]))
...
(deftest visit-given-houses-test
    (testing "Visit given houses"
        (testing "for no commands"
            (is (= [true [0 0] [0 0] [{:x 0 :y 0 :visits 2}]]
                   (visit-given-houses ""))))
        (testing "for >"
            (is (= [false [1 0] [0 0] [{:x 0 :y 0 :visits 2} {:x 1 :y 0 :visits 1}]]
                   (visit-given-houses ">"))))
        (testing "for ><"
            (is (= [true [1 0] [-1 0] [{:x 0 :y 0 :visits 2} {:x 1 :y 0 :visits 1} {:x -1 :y 0 :visits 1}]]
                   (visit-given-houses "><"))))
        ))
